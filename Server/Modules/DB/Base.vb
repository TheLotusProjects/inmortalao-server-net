...
ErrHandle:
    ...
    Sub SaveUserFlags(ByVal UserIndex As Integer, ByVal ipj As Integer)
        ...
        'Mod Graphic Ahora funcionan xD
...
ErrHandle:
    ...
    Function LoadUserSQL(UserIndex As Integer, ByVal Name As String) As Boolean
        ...
        With UserList(UserIndex)
            ...
            'Add Graphic Un fix por un error mio xD
            ...
            'Add Graphic agregamos esto para que funcione los casamientos. (xD)
...
LocalErr:
    ...
    Function GetIndexPJ(Name As String) As Integer
        ...
        'Add Graphic Si ya esta cargado para que buscarlo otra vez xD
...
Erro:
    ...
    Public Function EnviarCorreoSql(ByVal ipj As Integer, ByVal loopC As Byte, ByVal para As Integer) As Long
        ...
        With UserList(para)
            ...
            'Add Graphic Sin esto se puede duplicar objetos
            Dim id As Long
