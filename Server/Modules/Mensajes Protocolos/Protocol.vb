        ...
        With UserList(UserIndex)
            ...
            Else
                ...
                If Slot <= MAX_INVENTORY_SLOTS And Slot > 0 Then
                    ...
                    'Add Graphic no se pueden tirar objetos caos o reales
...
Errhandler:
    ...
    Private Sub HandleCasament(ByVal UserIndex As Integer)
        'Fix Graphic le pusimos el buffer auxiliar
        If UserList(UserIndex).incomingData.length < 3 Then
            Err.Raise(UserList(UserIndex).incomingData.NotEnoughDataErrCode)
            Exit Sub
        End If
...
Errhandler:
    ...
    Private Sub HandleOnlineMap(ByVal UserIndex As Integer)
        ...
        'Mod Graphic, ahora si funciona antes solo mostraba a los admin en el mapa.
        '***************************************************
        With UserList(UserIndex)
            'Remove packet ID
            Call .incomingData.ReadByte()
            ...
            If EsDIOS(UserIndex) Then
                ...
                If tUser > 0 Then
                    If EsDIOS(tUser) And Not tUser = UserIndex Then
                        Call WriteConsoleMsg(1, UserIndex, "Que estas haciendo... a un miembro del staff No! Habla con Graphic si tenes alguna duda.", FontTypeNames.FONTTYPE_INFO)
                    Else
...
Errhandler:
    ...
    Private Sub HandleMiliciaKick(ByVal UserIndex As Integer)
        '***************************************************
        ' Graphic (re que fue un Copiar & Pegar y le cambie 2 valores...)
        '***************************************************
        If UserList(UserIndex).incomingData.length < 3 Then
            Err.Raise(UserList(UserIndex).incomingData.NotEnoughDataErrCode)
            Exit Sub
...
Errhandler:
    ...
    Public Sub WriteShowForumForm(ByVal UserIndex As Integer)
        ...
        'Last Modification: 05/17/06
        'Writes the "ShowForumForm" message to the given user's outgoing data buffer
        'Add Graphic: Los muerto no abren correo
        '***************************************************
        On Error GoTo Errhandler
...
Errhandler:
    ...
    Public Sub HandleExtractItem(ByVal UserIndex As Integer)
        ...
        'Add Graphic Cada vez que extrae algo del correo se guarda el pj, Por si copro algo en el shop
...
err:
    ...
    Public Sub HandleEnviarMensaje(ByVal UserIndex As Integer)
        ...
        With UserList(UserIndex)
            ...
            'Add Graphic No se pueden mandar cosas faccionarias por correo xD y tampoco cosas de shop >= 50
           ...
           ObjDataArr(.Invent.Objeto(Slot).ObjIndex).Shop >= 49 Then
            ...
            If salir = False Then
                ...
                'Add Graphic Cada vez que mete algo que se guarde el pj para que no dupliquen con rollback
                Call SaveUserSQL(UserIndex)
                '\Add
            End If
...
Errhandler:
    ...
    Sub WriteCharMsgStatus(ByVal UserIndex As Integer, ByVal tI As Integer)
        ...
        With a
            ...
            'Add Graphic Visibilidad del Nivel - Mithrandir
    ...
    Sub HandleChatFaccion(ByVal UserIndex As Integer)
        ...
        With UserList(UserIndex)
            ...
            chat = Replace(chat, "~", "") 'Add Graphic No colores
...
Errhandler:
    ...
    Private Sub HandleParticipar(ByVal UserIndex As Integer)
        '*********************************************************************
        'Author: Jose Ignacio Castelli (Fedudok) Y su super compañero Graphic
        '*********************************************************************
        ...
        With UserList(UserIndex)
            ...
            ElseIf UserList(UserIndex).Stats.ELV < 25 Then
                ...
                Exit Sub
                'Add Graphic Seguimos con los presos
