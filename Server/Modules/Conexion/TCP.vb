...
Errhandler:
    ...
    Function ValidateChr(ByVal UserIndex As Integer) As Boolean
        ...
        'Add Graphic es una cabeza de enano bugeada y genera que no se vea el nombre de pj
    ...
    Sub ConnectUser(ByVal UserIndex As Integer, ByRef Name As String, ByRef account As String)
        ...
        Try
            ...
            With UserList(UserIndex)
                ...
                'Add Graphic Lideres Faccionarios
                ...
                'Fix Graphic Ya no mas caminatas sobre el agua!
    ...
    Sub SendMOTD(ByVal UserIndex As Integer)
        ...
        'Add Graphic Mandamos el evento activo.
